...
namespace Game
{
    public class CatapultTowerSecondState : TowerState
    {
        ...
        public override void HandleAttack(Enemy enemy, LevelCurencyHandler levelCurencyHandler)
        {
            ...
            _catapultProjectileWeaponFactory.SpawnWeapon(_weaponPointer, enemy, Config.AttackSpeed, Config.Damage, levelCurencyHandler);
        }
